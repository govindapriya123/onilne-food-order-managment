    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_GET['id']))
            {
                ...
                {
                    //redirect to manage category with sessional message
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        //check weather the image is removed or not and if failed to remove then diaplay message and stop the process
                        if($remove==false)
                        {
                    ...
                    {
                        //our image name is current image
